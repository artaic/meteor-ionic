class IonicBody extends IonicComponent {
  onCreated() {
    super.onCreated();
  }
  ...
  get platformClasses() {
    ...
    if ((Meteor.isCordova && super.isIOS()) || Session.get('platformOverride') === 'iOS') {
      classes.push('platform-ios');
    }
    if ((Meteor.isCordova && super.isAndroid()) || Session.get('platformOverride') === 'Android') {
